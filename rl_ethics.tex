...
~\cite{briggs2015sorry} discuss scenarios in which a robot ought to infer that a given command leads to undesirable behavior. 
...
There are several known PAC-MDP algorithms for solving MDPs, including Delayed-Q Learning~\shortcite{strehl2006pac}, \textsc{Rmax}~\shortcite{brafman2003r}, and $E^3$~\shortcite{kearns2002near}.
